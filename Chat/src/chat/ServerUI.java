...
public class ServerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(list2, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(22, 22, 22)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {                                      
        //Connector.setPassword(jTextField1.getText());
    }                                     
    ...
    public void commands(HashMap<String, FuncStore> Command){
        list2.removeAll();
        Command.forEach((String Cmd, FuncStore FuncStore)->{
            list2.add(Cmd);
        });
    ...
    public void addNames(HashMap<String,String> Name){
        list1.removeAll();
        Name.forEach((String ip,String name) -> {
            list1.add(name);
        });
    }
